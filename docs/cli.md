...
low for those. Claude Sonnet 5 is priced at its standard rate, not its
introductory one, so its estimate reads high until that introductory pricing
ends. Gemini's Pro models are priced at their short-prompt tier, so an eval
